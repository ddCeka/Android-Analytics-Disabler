...
- push the zip file to your /sdcard folder (use: adb push dss.zip /sdcard)
- open Magisk
- in the panel at the bottom, tap the "modules" icon
- at the top, select "install downloaded module"
- navigate to your /sdcard folder
- select dss.zip
...
> [!Note]
> You can simulate this with terminal app like [Termux](https://termux.com)
> can be used with package sudo, "pkg install sudo" then `sudo` (Confirmed usage with magisk 26.4)
> use of `adb` or straight `su` is fine
...
> Component {com.telkomsel.telkomselcm/com.google.android.gms.analytics.AnalyticsReceiver} new state: disabled
> Component {com.telkomsel.telkomselcm/com.google.android.gms.analytics.AnalyticsService} new state: disabled
...
> pm enable com.telkomsel.telkomselcm/com.facebook.internal.FacebookInitProvider

or just do:

> dss enable user com.telkomsel.telkomselcm
...
before doing the Play-system update.
